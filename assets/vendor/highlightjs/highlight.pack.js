    ...
    return {
        c: [
            {cN: "comment", b: "^/{4,}\\n", e: "\\n/{4,}$", r: 10}, {
                ...
                rB: true,
                c: [
                    {b: "(link|image:?):", r: 0}, {cN: "link_url", b: "\\w", e: "[^\\[]+", r: 0}, {
                        cN: "link_label",
                        b: "\\[",
                        e: "\\]",
                        eB: true,
...
hljs.registerLanguage("coffeescript", function (c)
{
    ...
    var d = [
        c.BNM, c.inherit(c.CNM, {starts: {e: "(\\s*/)?", r: 0}}), {
            cN: "string",
            v: [
                {b: /'''/, e: /'''/, c: [c.BE]}, {b: /'/, e: /'/, c: [c.BE]}, {b: /"""/, e: /"""/, c: [c.BE, e]}, {
                    b: /"/,
                    e: /"/,
                    c: [c.BE, e]
                }
        ...
        c: [
            {
                ...
                rE: false,
                c: [
                    {b: /([^\u2401\u0001=]+)/, e: /=([^\u2401\u0001=]+)/, rE: true, rB: false, cN: "attribute"}, {
                        b: /=/,
                        e: /([\u2401\u0001])/,
                        eE: true,
                        eB: true,
...
hljs.registerLanguage("mel", function (a)
{
    return {
        ...
        i: "</",
        c: [
            a.CNM, a.ASM, a.QSM, {cN: "string", b: "`", e: "`", c: [a.BE]}, {
                cN: "variable",
                v: [
                    {b: "\\$\\d"}, {b: "[\\$\\%\\@](\\^\\w\\b|#\\w+|[^\\s\\w{]|{\\w+}|\\w+)"}, {
                        b: "\\*(\\^\\w\\b|#\\w+|[^\\s\\w{]|{\\w+}|\\w+)",
...
hljs.registerLanguage("lasso", function (d)
{
    ...
    return {
        ...
        c: [
            ...
            }, {cN: "preprocessor", b: "\\[", r: 0}, {cN: "shebang", b: "^#!.+lasso9\\b", r: 10}
        ].concat(f)
    }
});
...
hljs.registerLanguage("python", function (a)
{
    ...
    var b = {
        ...
        c: [a.BE],
        v: [
            {b: /(u|b)?r?'''/, e: /'''/, c: [f], r: 10}, {b: /(u|b)?r?"""/, e: /"""/, c: [f], r: 10}, {
                b: /(u|r|ur)'/,
                e: /'/,
                r: 10
    ...
    return {
        ...
        i: /(<\/|->|\?)/,
        c: [
            f, d, b, a.HCM, a.inherit(c, {cN: "function", bK: "def", r: 10}), a.inherit(c, {
                cN: "class",
                bK: "class"
...
hljs.registerLanguage("profile", function (a)
{
    return {
        c: [
            a.CNM, {cN: "built_in", b: "{", e: "}$", eB: true, eE: true, c: [a.ASM, a.QSM], r: 0}, {
                cN: "filename",
...
hljs.registerLanguage("nginx", function (c)
{
    ...
    var a = {
        ...
        i: "=>",
        c: [
            c.HCM, {cN: "string", c: [c.BE, b], v: [{b: /"/, e: /"/}, {b: /'/, e: /'/}]}, {
                cN: "url",
                b: "([a-z]+):/",
                e: "\\s",
                eW: true,
...
hljs.registerLanguage("smalltalk", function (a)
{
    ...
    return {
        ...
        c: [
            {cN: "comment", b: '"', e: '"'}, a.ASM, {cN: "class", b: "\\b[A-Z][A-Za-z0-9_]*", r: 0}, {
                cN: "method",
                b: b + ":",
                r: 0
            }, a.CNM, c, d, {
...
hljs.registerLanguage("actionscript", function (a)
{
    ...
    return {
        ...
        c: [
            a.ASM, a.QSM, a.CLCM, a.CBLCLM, a.CNM, {cN: "package", bK: "package", e: "{", c: [a.TM]}, {
                cN: "class",
                bK: "class interface",
                e: "{",
                ...
                i: "\\S",
                c: [
                    a.TM, {cN: "params", b: "\\(", e: "\\)", c: [a.ASM, a.QSM, a.CLCM, a.CBLCLM, d]}, {
                        cN: "type",
                        b: ":",
                        e: b,
                        r: 10
        ...
        c: [
            {
                ...
                e: "}}",
                c: [
                    {cN: "begin-block", b: "#[a-zA-Z- .]+", k: a}, {cN: "string", b: '"', e: '"'}, {
                        cN: "end-block",
                        b: "\\/[a-zA-Z- .]+",
                        k: a
...
hljs.registerLanguage("scss", function (a)
{
    ...
    return {
        ...
        i: "[=/|']",
        c: [
            a.CLCM, a.CBLCLM, {cN: "function", b: c + "\\(", e: "\\)", c: ["self", a.NM, a.ASM, a.QSM]}, {
                cN: "id",
                b: "\\#[A-Za-z0-9_-]+",
                r: 0
...
hljs.registerLanguage("perl", function (c)
{
    ...
    var h = [c.BE, f, a];
    var b = [
        a, c.HCM, e, {cN: "comment", b: "^\\=\\w", e: "\\=cut", eW: true}, g, {
            cN: "string",
            c: h,
            v: [
            ...
            r: 0,
            c: [
                c.HCM, e, {cN: "regexp", b: "(s|tr|y)/(\\\\.|[^/])*/(\\\\.|[^/])*/[a-z]*", r: 10}, {
                    cN: "regexp",
                    b: "(m|qr)?/",
                    e: "/[a-z]*",
                    c: [c.BE],
...
hljs.registerLanguage("haskell", function (f)
{
    ...
    return {
        ...
        c: [
            {cN: "module", b: "\\bmodule\\b", e: "where", k: "module where", c: [c, g], i: "\\W\\.|;"}, {
                cN: "import",
                b: "\\bimport\\b",
                e: "$",
...
hljs.registerLanguage("avrasm", function (a)
{
    return {
        ...
        c: [
            a.CBLCLM, {cN: "comment", b: ";", e: "$", r: 0}, a.CNM, a.BNM, {
                cN: "number",
...
hljs.registerLanguage("axapta", function (a)
{
    return {
        ...
        c: [
            a.CLCM, a.CBLCLM, a.ASM, a.QSM, a.CNM, {cN: "preprocessor", b: "#", e: "$"}, {
                cN: "class",
                bK: "class interface",
                e: "{",
                i: ":",
...
hljs.registerLanguage("ocaml", function (a)
{
    return {
        ...
        i: /\/\//,
        c: [
            {cN: "string", b: '"""', e: '"""'}, {cN: "comment", b: "\\(\\*", e: "\\*\\)", c: ["self"]}, {
                cN: "class",
                bK: "type",
                e: "\\(|=|$",
                c: [a.UTM]
...
hljs.registerLanguage("erlang-repl", function (a)
{
    return {
        ...
        c: [
            {cN: "prompt", b: "^[0-9]+> ", r: 10}, {cN: "comment", b: "%", e: "$"}, {
                cN: "number",
...
hljs.registerLanguage("dos", function (a)
{
    return {
        ...
        c: [
            {cN: "envvar", b: "%%[^ ]"}, {cN: "envvar", b: "%[^ ]+?%"}, {cN: "envvar", b: "![^ ]+?!"}, {
                cN: "number",
                b: "\\b\\d+",
                r: 0
            }, {cN: "comment", b: "@?rem", e: "$"}
...
hljs.registerLanguage("go", function (a)
{
    ...
    return {
        ...
        i: "</",
        c: [
            a.CLCM, a.CBLCLM, a.QSM, {cN: "string", b: "'", e: "[^\\\\]'"}, {
                cN: "string",
                b: "`",
                e: "`"
            }, {
...
hljs.registerLanguage("rust", function (b)
{
    ...
    return {
        ...
        i: "</",
        c: [
            b.CLCM, b.CBLCLM, b.inherit(b.QSM, {i: null}), b.ASM, c, {
                cN: "function",
                bK: "fn",
                e: "(\\(|<)",
                c: [b.UTM]
        ...
        c: d.concat([
            {
                ...
                e: "\\)",
                c: [
                    b.inherit(b.TM, {b: "([_a-zA-Z]\\w*\\.)*([_a-zA-Z]\\w*:)?[_a-zA-Z]\\w*"}), {
                        cN: "params",
                        b: "\\(",
                        eW: true,
                        c: d
...
hljs.registerLanguage("rsl", function (a)
{
    return {
        ...
        i: "</",
        c: [
            a.CLCM, a.CBLCLM, a.QSM, a.ASM, a.CNM, {cN: "preprocessor", b: "#", e: "$"}, {
                cN: "shader",
...
hljs.registerLanguage("ruby", function (e)
{
    ...
    var d = {
        ...
        c: [e.BE, c],
        v: [
            {b: /'/, e: /'/}, {b: /"/, e: /"/}, {b: "%[qw]?\\(", e: "\\)"}, {b: "%[qw]?\\[", e: "\\]"}, {
                b: "%[qw]?{",
                e: "}"
            }, {b: "%[qw]?<", e: ">", r: 10}, {b: "%[qw]?/", e: "/", r: 10}, {
                b: "%[qw]?%",
                e: "%",
                r: 10
            }, {b: "%[qw]?-", e: "-", r: 10}, {
                        ...
                        c: [
                            {
                                ...
                                eW: true,
                                c: [
                                    {cN: "attribute", b: "\\w+", r: 0}, {cN: "string", b: '"', e: '"'}, {
                                        cN: "string",
                                        b: "'",
                                        e: "'"
                                    }, {b: "\\w+", r: 0}
        ...
        c: [
            {
                ...
                c: b,
                r: 0
            }, {cN: "cell", b: "\\{", e: "\\}'*[\\.']*", c: b, i: /:/}, {cN: "comment", b: "\\%", e: "$"}
        ].concat(b)
    }
});
...
hljs.registerLanguage("fsharp", function (a)
{
    return {
        ...
        c: [
            {cN: "string", b: '@"', e: '"', c: [{b: '""'}]}, {cN: "string", b: '"""', e: '"""'}, {
                cN: "comment",
                b: "\\(\\*",
                e: "\\*\\)"
...
hljs.registerLanguage("autohotkey", function (b)
{
    ...
    return {
        ...
        c: a.concat([
            d, b.inherit(b.QSM, {c: [d]}), c, {cN: "number", b: b.NR, r: 0}, {
                cN: "var_expand",
                b: "%",
                e: "%",
                i: "\\n",
...
hljs.registerLanguage("applescript", function (a)
{
    ...
    return {
        ...
        c: [
            b, a.CNM, {cN: "type", b: "\\bPOSIX file\\b"}, {
                cN: "command",
...
hljs.registerLanguage("vhdl", function (a)
{
    return {
        ...
        i: "{",
        c: [
            a.CBLCLM, {cN: "comment", b: "--", e: "$"}, a.QSM, a.CNM, {
                cN: "literal",
                b: "'(U|X|0|1|Z|W|L|H|-)'",
                c: [a.BE]
...
hljs.registerLanguage("cpp", function (a)
{
    ...
    return {
        ...
        i: "</",
        c: [
            a.CLCM, a.CBLCLM, a.QSM, {cN: "string", b: "'\\\\?.", e: "'", i: "."}, {
                cN: "number",
